...
void setboard11(char board[ROWS1][COLS1], int row, int col);
...
void setboard2(char board[ROWS2][COLS2], int row, int col);
...
void setboard3(char board[ROWS3][COLS3], int row, int col);
